...
UBTC_BITCOIN_RECEIVE_ADDRESS="bcrt1qrd4khgwjv27mmxndwzdslj3rjgk2l2uhk43u9k"  # deterministic address based on the network signing wallet's bip32 derivation path
