...
echo "SEQUENCER_RETH_STATIC_PEERS=${SEQUENCER_RETH_NODE_ID}@\${SEQUENCER_SOVA_RETH_IP}:30303"
echo "SEQUENCER_OP_STATIC_PEERS=/ip4/\${SEQUENCER_OP_NODE_IP}/tcp/9222/p2p/${SEQUENCER_OP_PEER_ID}"